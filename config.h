...
static const char *altbarcmd =
    "$HOME/.config/polybar/launch-dwm.sh"; /* Alternate bar launch command */
...
static const char *mic_mute[] = {"pactl", "set-source-mute", "@DEFAULT_SOURCE@",
                                 "toggle", NULL
                                };
static const char *brightness_up[] = {"xbacklight", "-inc", "5.0", NULL};
static const char *brightness_down[] = {"xbacklight", "-dec", "5.0", NULL};
static const char *profile_set[] = {"/home/jay/.local/bin/asus_profile.sh", NULL};

static Key keys[] = {
    /* modifier                     key        function        argument */
    /* PROGRAMS */
    {MODKEY, XK_r, spawn,
        SHCMD("j4-dmenu-desktop --dmenu=\"dmenu -h 27 -l 20 -bw 1 -p 'Run: '\" "
              "--term=\"alacritty\"")
    },
